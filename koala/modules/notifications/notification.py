...
from koala.modules.notifications.curd.notification import UserDevices
from koala.modules.notifications.mapper.notification import mapper_register_device
